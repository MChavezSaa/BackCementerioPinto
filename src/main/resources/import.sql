...
INSERT INTO `patio` (id_patio, capacidad_patio, estado_patio, nombre_patio, id_terreno) VALUES (1, 3, b'1', 'patio 1', 1);

INSERT INTO `tipo_tumba` (id_tipo_tumba, capacidad_tipo_tumba, estado_tipo_tumba, nombre_tipo_tumba) VALUES (1, 3, b'1', 'simple');

INSERT INTO `tumba` (id_tumba, ancho, estado_tumba, largo, numero_tumba, orientacion_tumba, valor_tumba, id_cliente, id_patio, id_tipo_tumba) VALUES (1, 0, b'0', 0, 1, NULL, 0, NULL, 1, NULL);
INSERT INTO `tumba` (id_tumba, ancho, estado_tumba, largo, numero_tumba, orientacion_tumba, valor_tumba, id_cliente, id_patio, id_tipo_tumba) VALUES (2, 0, b'0', 0, 2, NULL, 0, NULL, 1, NULL);
INSERT INTO `tumba` (id_tumba, ancho, estado_tumba, largo, numero_tumba, orientacion_tumba, valor_tumba, id_cliente, id_patio, id_tipo_tumba) VALUES (3, 0, b'0', 0, 3, NULL, 0, NULL, 1, NULL);
